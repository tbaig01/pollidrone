...
import { AlertTriangle, TrendingDown, Skull, Activity, Factory, DollarSign, Sprout } from 'lucide-react';
import '../index.css';
...
export default function PresentationOverlay() {
    ...
    return (
        <div style={{
            ...
            minWidth: '450px',
            height: '100%',
            background: 'linear-gradient(to right, rgba(3,3,3,1) 60%, rgba(3,3,3,0))',
            padding: '48px',
            display: 'flex',
            ...
            {/* Header */}
            <div>
                <h1 className="hud-title" style={{ fontSize: '32px', marginBottom: '8px' }}>THE COLLAPSE</h1>
                <h2 className="hud-subtitle" style={{ fontSize: '16px', color: 'var(--red-alert)' }}>
            ...
            <div style={{
                ...
                <div style={{ fontSize: '48px', fontWeight: 700, color: 'var(--red-alert)', lineHeight: 1, marginBottom: '8px' }}>
                    500,000
                </div>
                <div style={{ color: 'var(--gold-primary)', fontSize: '18px', marginBottom: '16px' }}>
                    early deaths annually
                </div>
                <p style={{ color: 'var(--gold-text-muted)', fontSize: '14px', lineHeight: 1.5, margin: 0 }}>
                    Attributed to lower consumption of healthy foods due to insufficient pollination.
                    <br /><span style={{ opacity: 0.6, fontSize: '12px' }}>Source: The Lancet Planetary Health</span>
                </p>
                <div style={{ position: 'absolute', top: -20, right: -20, opacity: 0.05 }}>
                    <Skull size={150} color="var(--red-alert)" />
                </div>
            </div>
